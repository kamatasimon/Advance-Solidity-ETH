    ...
    <div className="flex justify-between items-start mt-10">
      <div className="flex flex-col w-1/2">
        ...
        >
          ...
          <div className="mb-4">
            <label htmlFor="salt" className="text-md font-semibold text-orange-700 mb-2">
              Salt
            </label>
            <input
              type="text"
        ...
        >
          ...
          <div className="mb-4">
            <label htmlFor="newsalt" className="text-md font-semibold text-orange-700 mb-2">
              Salt
            </label>
            <input
              type="number"
        ...
        {newAddress && (
          <div className="bg-orange-200 py-2 px-4 mt-4 rounded">
            Address: {newAddress}
          </div>
        )}
      </div>
